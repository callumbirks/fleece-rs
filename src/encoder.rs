...
impl Encodable for i64 {
    fn encode(&self, encoder: &mut Encoder<impl Write>) {
        ...
        encoder
            .write_bytes(&buf[..=(size as usize)])
            .expect("Failed to write i64 bytes");
    }
}
...
impl Encodable for u64 {
    fn encode(&self, encoder: &mut Encoder<impl Write>) {
        ...
        encoder
            .write_bytes(&buf[..=(size as usize)])
            .expect("Failed to write u64 bytes");
    }
}
...
impl Encodable for f32 {
    fn encode(&self, encoder: &mut Encoder<impl Write>) {
        ...
        encoder
            .write_bytes(&buf)
            .expect("Failed to write f32 bytes");
    }
}
...
impl Encodable for f64 {
    fn encode(&self, encoder: &mut Encoder<impl Write>) {
        ...
        encoder
            .write_bytes(&buf)
            .expect("Failed to write f64 bytes");
    }
}
...
impl Encodable for bool {
    fn encode(&self, encoder: &mut Encoder<impl Write>) {
        if *self {
            encoder
                .write_bytes(&value::constants::TRUE)
                .expect("Failed to write bool bytes");
        } else {
            encoder
                .write_bytes(&value::constants::FALSE)
                .expect("Failed to write bool bytes");
        }
    }
}
